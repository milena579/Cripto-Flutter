import 'package:flutter_application_1/moeda.dart';
...
class MoedaRepository {
  static List<Moeda> tabela = [
    ...
    Moeda(icone: 'images/cardano.webp', nome: 'Cardano', sigla: 'ADA', preco: 6.32),

    Moeda(icone: 'images/usdcoin.png', nome: 'USD Coin', sigla: 'USDC', preco: 5.02),
